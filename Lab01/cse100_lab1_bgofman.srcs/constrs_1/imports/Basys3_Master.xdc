...
## Switches
set_property PACKAGE_PIN V17 [get_ports {d0}];		    # sw[0] (reminder)	
	set_property IOSTANDARD LVCMOS33 [get_ports {d0}]
set_property PACKAGE_PIN V16 [get_ports {d1}];			# sw[1]		
	set_property IOSTANDARD LVCMOS33 [get_ports {d1}]
set_property PACKAGE_PIN W16 [get_ports {d2}];		    # sw[2]	
...
set_property PACKAGE_PIN U2 [get_ports {AN0}];			# an[0]	
	set_property IOSTANDARD LVCMOS33 [get_ports {AN0}]
set_property PACKAGE_PIN U4 [get_ports {AN1}];			# an[1]		
	set_property IOSTANDARD LVCMOS33 [get_ports {AN1}]
set_property PACKAGE_PIN V4 [get_ports {AN2}];			# an[2]		
	set_property IOSTANDARD LVCMOS33 [get_ports {AN2}]
set_property PACKAGE_PIN W4 [get_ports {AN3}];			# an[3]		
