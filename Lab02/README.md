...
# CSE100 Lab 2 – Vivado Project

This repository contains the source files for **CSE100 Lab 2**. Follow the steps below to set up your environment and open the project in **Xilinx Vivado 2025.1**.
...
2. **Open the Project in Vivado**  
   ...
   - Select `cse100_lab2_bgofman.xpr` from the extracted directory.
...
```
cse100_lab2_bgofman/
├─ cse100_lab2_bgofman.xpr             # Vivado project file
├─ cse100_lab2_bgofman.srcs/sources_1  # HDL source files
├─ cse100_lab2_bgofman.srcs/constrs_1  # XDC constraint files
```
